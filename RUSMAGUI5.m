function varargout = RUSMAGUI5(varargin)
% RUSMAGUI5 MATLAB code for RUSMAGUI5.fig
%      RUSMAGUI5, by itself, creates a new RUSMAGUI5 or raises the existing
%      singleton*.
%
%      H = RUSMAGUI5 returns the handle to a new RUSMAGUI5 or the handle to
%      the existing singleton*.
%
%      RUSMAGUI5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RUSMAGUI5.M with the given input arguments.
%
%      RUSMAGUI5('Property','Value',...) creates a new RUSMAGUI5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before RUSMAGUI5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to RUSMAGUI5_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help RUSMAGUI5

% Last Modified by GUIDE v2.5 02-Oct-2021 13:55:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @RUSMAGUI5_OpeningFcn, ...
                   'gui_OutputFcn',  @RUSMAGUI5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before RUSMAGUI5 is made visible.
function RUSMAGUI5_OpeningFcn(hObject, eventdata, handles, varargin)
global a;
global b;

gambar1 = imread('image1.png')
gambar2 = imread('image2.png')
